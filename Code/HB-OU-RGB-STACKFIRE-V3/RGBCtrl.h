...
#define LOGIC_INVERSMUL 16
  ...
  CRGB leds13[WSNUM_LEDS13];
  CRGB leds14[WSNUM_LEDS14];
  CRGB leds15[WSNUM_LEDS15];
  ...
  public:
    ...
    void setColor(uint8_t val) {       
      ...
      for (int i = 0; i < WSNUM_LEDS11; i++) {
        leds11[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      } 
      for (int i = 0; i < WSNUM_LEDS12; i++) {
        leds12[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      }      
      for (int i = 0; i < WSNUM_LEDS13; i++) {
        leds13[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      }
      for (int i = 0; i < WSNUM_LEDS14; i++) {
        leds14[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      } 
      for (int i = 0; i < WSNUM_LEDS15; i++) {
        leds15[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      }      
      for (int i = 0; i < WSNUM_LEDS16; i++) {
        leds16[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      }
      for (int i = 0; i < WSNUM_LEDS17; i++) {
        leds17[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      } 
      for (int i = 0; i < WSNUM_LEDS18; i++) {
        leds18[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      } 
      ...
      for (int i = 0; i < WSNUM_LEDS21; i++) {
        leds21[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      } 
      for (int i = 0; i < WSNUM_LEDS22; i++) {
        leds22[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      } 
      for (int i = 0; i < WSNUM_LEDS23; i++) {
        leds23[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      }       
      ...
      for (int i = 0; i < WSNUM_LEDS26; i++) {
        leds26[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      } 
      for (int i = 0; i < WSNUM_LEDS27; i++) {
        leds27[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      } 
      for (int i = 0; i < WSNUM_LEDS28; i++) {
        leds28[i] = CHSV((val * 1275L) / 1000, (val <  200) ? 255 : 0, 255);
      }    
...
class RGBLEDDevice : public MultiChannelDevice<HalType, ChannelType, ChannelCount, List0Type> {
  ...
  public:
    ...
    virtual void configChanged () {
      ...
      FastLED.addLeds<WSLED_TYPE, WSLED_PIN_13, WSCOLOR_ORDER>(leds13, WSNUM_LEDS13);
      FastLED.addLeds<WSLED_TYPE, WSLED_PIN_14, WSCOLOR_ORDER>(leds14, WSNUM_LEDS14);
      FastLED.addLeds<WSLED_TYPE, WSLED_PIN_15, WSCOLOR_ORDER>(leds15, WSNUM_LEDS15);
      FastLED.addLeds<WSLED_TYPE, WSLED_PIN_16, WSCOLOR_ORDER>(leds16, WSNUM_LEDS16);
      FastLED.addLeds<WSLED_TYPE, WSLED_PIN_17, WSCOLOR_ORDER>(leds17, WSNUM_LEDS17);
      ...
      FastLED.addLeds<WSLED_TYPE, WSLED_PIN_23, WSCOLOR_ORDER>(leds23, WSNUM_LEDS23);
      FastLED.addLeds<WSLED_TYPE, WSLED_PIN_24, WSCOLOR_ORDER>(leds24, WSNUM_LEDS24);
      FastLED.addLeds<WSLED_TYPE, WSLED_PIN_25, WSCOLOR_ORDER>(leds25, WSNUM_LEDS25);
